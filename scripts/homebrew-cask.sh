...
mkdir -p "$(dirname "${output}")"
{
	...
	printf '  version "%s"\n\n' "${version}"
	printf '  on_macos do\n'
	arch_block on_arm "${sha_darwin_arm64}" darwin_arm64
	arch_block on_intel "${sha_darwin_amd64}" darwin_amd64
	printf '  end\n'
	printf '  on_linux do\n'
	arch_block on_arm "${sha_linux_arm64}" linux_arm64
	arch_block on_intel "${sha_linux_amd64}" linux_amd64
	printf '  end\n\n'
	printf '%s\n' '  name "speedns"'
